...
public class Fourth_dimension extends AppCompatActivity {
    String[] data = {"milliseconds","seconds", "minutes", "hours", "days", "weeks", "months(30 days)", "year(365 days)"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinner = (Spinner) findViewById(R.id.from_type_f);
        Spinner spinner1 = (Spinner) findViewById(R.id.spinner_f);
        try {
    ...
    void type_init(){
        ...
        types.put("months(30 days)", "2592000.0");
        types.put("year(365 days)", "31536000.0");
    }
    ...
    void Fourth_convetrer(String from, String to, String amount){
        ...
        scale = sss.getDefaults("scale",Fourth_dimension.this);
        int count = 0;
